...
build_and_load "api-gateway"           "services/api-gateway"   "novalink/api-gateway:$IMAGE_TAG"
...
bash "$SCRIPT_DIR/init-k8s-db.sh"
...
kubectl set image deployment/api-gateway           api-gateway="novalink/api-gateway:$IMAGE_TAG"
# --- Esperar rollout ---
